...
class TaskGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Task entity")
        ...
        .repeat(2) {
            ...
            .get("/services/gdata/api/tasks")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new task")
            .post("/services/gdata/api/tasks")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
                , "type":"SAMPLE_TEXT"
                , "startime":"SAMPLE_TEXT"
                , "endtime":"SAMPLE_TEXT"
                , "realtime":"SAMPLE_TEXT"
                , "status":"SAMPLE_TEXT"
                }""")).asJson
            .check(status.is(201))
            ...
            .repeat(5) {
                ...
                .get("/services/gdata${new_task_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created task")
            .delete("/services/gdata${new_task_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
